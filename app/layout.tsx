                                ...
                                <div className="block w-full h-full md:h-auto">
                                    <ul className="space-y-8 tracking-wide font-medium md:flex md:space-y-0">
                                      <>
                                        {/* {menu.map((item, index) => { 
                                          <li key={index}>
                                              <MenuNavLink href={item.path}>{item.title}</MenuNavLink>
                                          </li>
                                        })} */}
                                        <MenuNavLink/>
                                        ...
                                        <li>
                                            <Link href="/notes" className="block md:px-3 group">
                                                <div
                                                    ...
                                                    <span
                                                        className="transition group-hover:text-yellow-700 dark:text-gray-300 dark:group-hover:text-yellow-300">Notes</span>
                                                </div>
                                            </Link>
                                        </li>
                                    </ul>
